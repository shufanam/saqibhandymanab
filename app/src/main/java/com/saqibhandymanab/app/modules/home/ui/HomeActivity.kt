package com.saqibhandymanab.app.modules.home.ui
...
import com.saqibhandymanab.app.databinding.ActivityHomeBinding
import com.saqibhandymanab.app.modules.clientprofilecontainer.ui.ClientProfileContainerActivity
import com.saqibhandymanab.app.modules.home.`data`.model.HomeRowModel
import com.saqibhandymanab.app.modules.home.`data`.viewmodel.HomeVM
import kotlin.Int
...
class HomeActivity : BaseActivity<ActivityHomeBinding>(R.layout.activity_home) {
  ...
  override fun setUpClicks(): Unit {
    binding.linearProfile.setOnClickListener {
      val destIntent = ClientProfileContainerActivity.getIntent(this, null)
